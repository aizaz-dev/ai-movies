...
<Topstory/>
      ...
      <div className="max-w-[2000px] mx-auto  w-[100%] flex flex-col lg:px-[80px] px-[20px] pt-[50px]">
        ...
        <div className="lg:text-sm bg-light200 lg:w-[90%] w-[100%] p-[50px] text-xs font-[Outfit-Bold] text-white">
      ...
      <div className="max-w-[2000px] mx-auto  w-[100%] flex flex-col lg:px-[80px] px-[20px] py-[50px] pt-[50px] bg-light100 mt-[50px]">
        ...
        <div className="flex lg:flex-row md:flex-row flex-col w-full justify-center items-center gap-6">
          ...
          <div className=" text-center">
            ...
            <div className="lg:text-[25px] md:text-[20px] text-[18px] font-bold text-blue-800">
              JOHANNES TIEMEYER
            </div>
          </div>
      ...
      <div className="w-full lg:p-[40px] md:p-[30px] p-[20px]">
        ...
        <button className="text-white bg-primary hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mt-5">
