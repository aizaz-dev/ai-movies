...
const Wecase = () => {
  ...
  const [selectedCategoryData, setSelectedCategoryData] =
    useState<CategoryData>({
      description:
        "Sorgen Sie für Rechtskonformität im Unternehmen. Mit Hilfe unserer Technologie vermitteln Sie gesetzliche Anforderungen wie das Geldwäschegesetz oder das Lieferkettengesetz sowie den Einsatz neuer Technologien wie ChatGPT klar und prägnant.",
      industries: [
      ...
      <div className="max-w-[2000px] m-auto">
        ...
        <div className="flex max-md:flex-col gap-10">
          ...
          <div className="half bg-light400 rounded-[10px] w-[30%] h-fit max-md:w-full shadow-md">
            <div className="child bg-light200 max-laptop:pl-[20px] rounded-[10px] max-tab:pl-[0px]">
