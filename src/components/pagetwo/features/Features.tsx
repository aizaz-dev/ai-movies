    ...
    <div className="w-full mt-[60px] bg-light100 p-[80px] max-md:p-[30px] max-tab:p-[40px]">
      <div className="max-w-[2000px] mx-auto flex flex-col items-center w-[100%]">
        <div className="w-[95%]">
          ...
          <h3 className='text-sm font-bold font-[Outfit-Bold] text-primary max-md:text-center max-laptop:text-mf'>        {t("feature.heading1")}
</h3>
    <h1 className='text-lg font-[Outfit-Bold]  max-md:text-sm max-md:text-center max-laptop:text-lf'> {t("feature.heading3")}</h1>
          </div>
