...
const [selectedStep, setSelectedStep] = useState(0);
  ...
  return (
    <div className='w-full  mt-[90px]  '>
      ...
      <h3 className='px-[80px] max-laptop:px-[60px] max-md:px-[30px] text-sm font-[Outfit-Bold] text-primary max-md:text-center max-laptop:text-mf'>          {t("Webapp.TopHeading")}
</h3>
        <h1 className='px-[80px] max-laptop:px-[60px] max-md:px-[30px] text-lg font-[Outfit-Bold] max-md:text-sm max-md:text-center max-laptop:text-lf '>          {t("Webapp.SubHeading")}
</h1>
