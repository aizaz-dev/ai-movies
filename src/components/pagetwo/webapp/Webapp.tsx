...
const Webapp = () => {
  return (
    <div className='w-full mt-[50px] p-[80px] max-laptop:p-[60px] max-md:p-[30px] '>
...
<div className="desc  p-4 pt-0 flex items-start justify-start flex-col gap-14 max-md:gap-10 max-laptop:gap-[50px]">
    <div className="first">
        ...
        <p className='text-sm max-md:text-mf font-[Outfit-Regular] leading-7 max-laptop:text-[15px] max-laptop:leading-4 max-md:leading-5'>Wählen Sie ihre Farben und Schriftarten <br className='max-md:hidden'/> aus und laden Sie Ihr Logo hoch.</p>
    </div>
    <div className="first">
