...
ACT NOW
      ...
      Bereit für eine digitale Transformation?
      </h1>
      ...
      Machen Sie den richtigen Schritt für effizientere und engagierte Weiterbildung – mit nur einem Klick.
            ...
            <button className='text-white bg-primary text-sm max-laptop:text-mf font-bold border-[2px] border-solid border-primary py-[10px] px-[15px] rounded-[10px] mt-6 max-md:text-[14px] whitespace-nowrap max-md:mx-auto'>Kontakt aufnehmen</button>
            <button className='text-primary text-sm max-laptop:text-mf font-bold border-[2px] border-solid border-primary py-[10px] px-[15px] rounded-[10px] mt-6 max-md:text-[14px] whitespace-nowrap max-md:mx-auto'>Haufige Fragen</button>
