  ...
  return (
    <div className="relative w-full m-auto">
      <div className="overflow-hidden bg-light100 w-full lg:flex-row flex flex-col  items-center justify-center py-[80px] max-md:py-[30px] px-[80px] max-tab:px-[40px] max-laptop:px-[80px] max-md:px-[30px] gap-[4%] relative">
        ...
        {/* Content */}
        <div className="max-w-[2000px] w-full mx-auto flex gap-[20px] max-tab:justify-center max-tab:gap-[60px] max-md:gap-[0px] max-maxtab:flex-col  items-start px-[40px] max-lg:p-[40px] max-md:p-[10px] relative z-20">
          <div className="w-[50%] max-maxtab:w-full flex-col  ">
